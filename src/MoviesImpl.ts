...
export class Movies implements IMovies {
    ...
    async addMovie(movie: IMovie): Promise<boolean> {
        const result = await this.db.query('INSERT INTO movies VALUES ($1, $2, $3, $4, $5, $6, $7)',
            [movie.title, movie.language, movie.overview, movie.release_date, movie.adult, movie.ratings, movie.popularity]);
