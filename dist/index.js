...
const MoviesRoutes_1 = require("./src/routes/MoviesRoutes");
...
app.use("/api", FavoriteMoviesRoutes_1.favoritesRouter, UsersRoutes_1.usersRouter, MoviesRoutes_1.moviesRouter);
app.get("/", (req, res) => {
